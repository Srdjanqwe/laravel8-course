...
class CommentPosted extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this
                ...
                // ->attachData(Storage::get($this->comment->user->image->path), 'profile_picture.jpeg',[ 'mime' => 'image\jpeg']) // permission za ovo mozda treba
                ->subject('$subject')
                ->view('emails.posts.commented'); // ovde mozes config subject from etc
    }
}
